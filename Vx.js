/**************************************
[rewrite_local]
^https:\/\/api\.tuhu\.cn\/user\/UserCheckInVersion1\?channel\=wxapp url script-request-header https://raw.githubusercontent.com/Crazy-Z7/Task/main/Vx.js
[task_local]
 40 8 * * * https://raw.githubusercontent.com/Crazy-Z7/Task/main/Vx.js, tag=vx,enabled=true
[MITM]
hostname = api.tuhu.cn
*****************************************/

const $ = new Env("途虎vx")
$.signKey = 'tuhu_userSignKey'
